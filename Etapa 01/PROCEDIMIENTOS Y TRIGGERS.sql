...
GO
CREATE OR ALTER PROCEDURE SP_INSERTAR_PRODUCTO(@ID_PRODUCTO BIGINT OUT,
											   @ID_PROVEEDOR INT,
	...
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
				...
				ELSE
					BEGIN
						INSERT INTO PRODUCTOS(ID_PRODUCTO,ID_PROVEEDOR,NOMBRE_PROVEEDOR,DESCRIPCION,PRECIO_UNIDAD)
										VALUES(@ID_PRODUCTO,@ID_PROVEEDOR,@NOMBRE_PROVEEDOR,@DESCRIPCION,@PRECIO_UNIDAD)
...
GO
CREATE OR ALTER PROCEDURE SP_ELIMINAR_PRODUCTO(@ID_PRODUCTO BIGINT OUT, @MSJ VARCHAR(200) OUT)
AS
	BEGIN
		BEGIN TRY
			BEGIN TRANSACTION
